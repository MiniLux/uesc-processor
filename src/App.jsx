...
const DITHER_ALGOS = {
  ...
  "Plus":{g:"Shape"},"Numbers":{g:"Shape"},"Grid Matrix":{g:"Shape"},"Brackets":{g:"Shape"},"Edge Detect":{g:"Shape"},"Shape Dots":{g:"Shape"},"Maze":{g:"Shape"},"Glyph Map":{g:"Shape"},
  "Threshold":{g:"Basic"},
};
...
export default function UESCProcessor(){
  ...
  const startRec=async()=>{
    ...
    if(fmt==="mp4"){
      ...
      else{mime="video/webm;codecs=vp9";ext="webm";setErr("MP4 not supported, using WebM");}
    } else {
